...
<div class="relative">
  ...
  {#if showDropdown}
    <div 
      ...
      class="absolute bottom-full mb-2 left-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-gray-200 dark:border-slate-700 shadow-xl rounded-lg overflow-hidden z-50 min-w-[120px]"
    >
