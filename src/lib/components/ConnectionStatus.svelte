...
<div class="absolute bottom-0 left-0 right-0 z-20 p-2 border-t border-gray-200/50 dark:border-slate-700/70 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl">
    <button 
