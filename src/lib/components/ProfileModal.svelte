...
{#if isOpen}
    <div 
        class="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 {isAndroidApp ? 'pt-10' : ''}"
        role="dialog"
        aria-modal="true"
        tabindex="-1"
    ...
    >
        <div class="bg-white/85 dark:bg-slate-900/85 backdrop-blur-xl w-full max-w-xl h-auto max-h-[85vh] rounded-3xl flex flex-col shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden relative outline-none">
