const pt = {
    ...
    chats: {
        ...
        favorites: 'Favoritos',
        favoriteMessage: 'mensagem',
        favoriteMessages: 'mensagens',
        emptyFavorites: 'Ainda não há mensagens favoritas',
        export: 'Exportar',
        archive: 'Arquivar',
    ...
    sync: {
        ...
        manualRelay: {
            label: 'Ou insira um relay manualmente',
    ...
    modals: {
        ...
        locationPreview: {
            ...
            ctrlScrollToZoom: 'Use Ctrl + scroll para dar zoom'
        },
