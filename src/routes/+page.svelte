<script lang="ts">
  ...
  async function loginWithGeneratedKeypair(
...
<div class="flex flex-col items-center justify-center h-full p-4">
  <div
    class="p-8 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl w-full max-w-md rounded-3xl shadow-2xl border border-white/20 dark:border-white/10"
  >
    <img
      src="/nospeak.svg"
      alt="nospeak logo"
      class="mx-auto mb-4 h-20 app-logo drop-shadow-sm"
    />
    <h1 class="typ-title mb-8 text-center dark:text-white">nospeak</h1>

    {#if error}
      <div
        class="bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-300 p-4 rounded-xl mb-6 text-sm border border-red-100 dark:border-red-800"
      >
        {error}
      </div>
    {/if}
    ...
    <div class="relative my-8">
      <div class="absolute inset-0 flex items-center">
        <div
          class="w-full border-t border-gray-200/50 dark:border-gray-700"
        ></div>
      </div>
      <div class="relative flex justify-center">
        <span
          class="typ-meta px-4 bg-transparent text-gray-500 dark:text-gray-400 bg-white/0 backdrop-blur-sm rounded-full"
          >{$t("auth.orSeparator")}</span
        >
      </div>
    </div>
  ...
  {#if !isAndroidShell}
    ...
    >
      ...
      >
        <path
          d="M35.361,5.677l2.497-4.162c0.284-0.474,0.131-1.088-0.343-1.372c-0.475-0.285-1.088-0.132-1.372,0.343l-2.635,4.392
        ...
        />
        <path
          d="M35.478,11.364H34.16c-0.364,0-0.659,0.295-0.659,0.659v1.318c0,0.364,0.295,0.659,0.659,0.659h1.319
                    c0.364,0,0.659-0.295,0.659-0.659v-1.318C36.138,11.659,35.842,11.364,35.478,11.364z"
        />
        <path
          d="M22.841,11.364h-1.319c-0.364,0-0.659,0.295-0.659,0.659v1.318c0,0.364,0.295,0.659,0.659,0.659h1.319
                    c0.364,0,0.659-0.295,0.659-0.659v-1.318C23.5,11.659,23.205,11.364,22.841,11.364z"
        />
        <path
          d="M42.5,21.001h-28c-0.552,0-1,0.447-1,1v20.171c0,2.663,2.169,4.829,4.834,4.829H19.5v6.006c0,2.202,1.794,3.994,4,3.994
        ...
        />
        <path
          d="M48,21.001c-1.93,0-3.5,1.572-3.5,3.504v13.992c0,1.932,1.57,3.504,3.5,3.504s3.5-1.572,3.5-3.504V24.505
        ...
        />
        <path
          d="M9,21.001c-1.93,0-3.5,1.572-3.5,3.504v13.992c0,1.932,1.57,3.504,3.5,3.504s3.5-1.572,3.5-3.504V24.505
