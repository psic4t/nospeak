# npub-mentions Specification

## Purpose
Detection, resolution, and rendering of Nostr npub references within message content as interactive inline mentions with profile modal integration.
