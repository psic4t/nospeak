# chat-visit-refresh Specification

## Purpose
On-demand contact profile and relay refresh triggered by chat navigation, replacing the former bulk startup refresh of all contacts.
